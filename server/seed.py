...
with app.app_context():
    ...
    review2 = Review(rating=4, text="Great amenities! Rooms could use improvement.", hotel_id=2, customer_id=1)
    review3 = Review(rating=3, text="Could be better.", hotel_id=2, customer_id=2)
    review4 = Review(rating=2, text="Not as good as the first time I visited.", hotel_id=1, customer_id=1)
